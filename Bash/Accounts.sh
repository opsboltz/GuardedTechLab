...
for authUser in "${authUsersArray[@]}"; do
    ...
    # Save the new password in a file
    echo "Username: $authUser, New Password: $new_password" > new_password.txt
done
...
for unauthUser in "${unauthUsersArray[@]}"; do
    ...
    # Save the new password in a file
    echo "Username: $unauthUser, New Password: $new_password" > new_password.txt
done
